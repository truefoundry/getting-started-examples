...
parser.add_argument(
    "--name",
    required=False,
    default="mnist-classifier-mms-svc",
    type=str,
...
service = Service(
    ...
    image=Build(
        ...
        build_spec=DockerFileBuild(
            ...
            command="multi-model-server --foreground --start --mms-config /home/model-server/config.properties",
        ),
    ),
    ...
    resources=Resources(
        ...
        memory_request=500,
        memory_limit=600,
        # Uncomment the next line to add GPU devices to the service
