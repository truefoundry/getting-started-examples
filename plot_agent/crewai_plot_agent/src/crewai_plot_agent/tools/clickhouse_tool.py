...
class ClickHouseTool(BaseTool):
    ...
    def __init__(self):
        super().__init__()
        print("Initializing ClickHouseTool", os.getenv('CLICKHOUSE_HOST'), os.getenv('CLICKHOUSE_PORT'), os.getenv('CLICKHOUSE_USER'), os.getenv('CLICKHOUSE_PASSWORD'), os.getenv('CLICKHOUSE_DATABASE'))
