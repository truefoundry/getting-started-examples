...
class PlotTools(BaseTool):
    ...
    def _run(self, data: str, plot_type: str, x_col: str, y_col: Optional[str] = None, 
             title: Optional[str] = None, hue: Optional[str] = None, figsize: Optional[List[float]] = [12, 8],
             style: Optional[str] = "seaborn-v0_8-darkgrid", palette: Optional[str] = "husl",
             output_path: Optional[str] = None, job_id: Optional[str] = None) -> str:
