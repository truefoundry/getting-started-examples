        ...
        try:
            ...
            while retries < max_retries:
                try:
                    ...
                    if current_status == "completed" or (current_status == "failed" and status_result.get("plot_result") is not None):
                        try:
                    ...
                    if retries % 5 == 0:  # Update message every 5 seconds
                        status_placeholder.info(f"Processing your query... Please wait.")
