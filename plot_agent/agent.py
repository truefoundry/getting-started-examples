...
class SQLAndPlotWorkflow(Workflow):
    ...
    sql_agent: Agent = Agent(
        ...
        description="You are an expert in generating Clickhouse SQL queries from user queries in English.",
        instructions=[
            ...
            "Generate optimized and accurate Clickhouse SQL queries based on user queries, ensuring that only relevant fields are selected and queries are efficient."
        ],
